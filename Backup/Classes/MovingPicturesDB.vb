...
#Region "Constructors"
    ...
    Private Sub OpenMovingPicturesDB()
        Try
            ...
            If File.Exists(layer.GetSetting("TvMovieMPDatabase", "C:\ProgramData\Team MediaPortal\MediaPortal\database").Value & "\movingpictures.db3") = True Then

                m_db = New SQLiteClient(layer.GetSetting("TvMovieMPDatabase", "C:\ProgramData\Team MediaPortal\MediaPortal\database").Value & "\movingpictures.db3")
            ...
            Else
                MyLog.[Error]("TVMovie: [OpenMovingPicturesDB]: TvSeries Database not found: {0}", layer.GetSetting("TvMovieMPDatabase", "C:\ProgramData\Team MediaPortal\MediaPortal\database").Value & "\movingpictures.db3")
            End If
