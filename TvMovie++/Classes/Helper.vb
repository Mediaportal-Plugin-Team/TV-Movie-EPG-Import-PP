    ...
    Public Shared Sub CreateOrClearTvMovieProgramTables()
        ...
        If Gentle.Framework.Broker.ProviderName = "MySQL" Then
            ...
            Try
                ...
                Broker.Execute("CREATE TABLE mptvdb.TVMovieProgram ( idProgram INT NOT NULL , TVMovieBewertung INT NOT NULL DEFAULT 0 , FanArt VARCHAR(255) , idSeries INT NOT NULL DEFAULT 0 , SeriesPosterImage VARCHAR(255) , idEpisode VARCHAR(15) , EpisodeImage VARCHAR(255) , local BIT(1) NOT NULL DEFAULT 0 , idMovingPictures INT NOT NULL DEFAULT 0 , idVideo INT NOT NULL DEFAULT 0 , KurzKritik VARCHAR(255) , BildDateiname VARCHAR(255) , Cover VARCHAR(512) , Fun INT NOT NULL DEFAULT 0 , Action INT NOT NULL DEFAULT 0 , Feelings INT NOT NULL DEFAULT 0 , Erotic INT NOT NULL DEFAULT 0 , Tension INT NOT NULL DEFAULT 0 , Requirement INT NOT NULL DEFAULT 0 , Actors TEXT , Dolby BIT(1) NOT NULL DEFAULT 0 , HDTV BIT(1) NOT NULL DEFAULT 0 , Country VARCHAR(50) , Regie VARCHAR(50) , Describtion TEXT , ShortDescribtion TEXT , FileName VARCHAR(255) , PRIMARY KEY (idProgram) )")
        ...
        Else
            ...
            Try
                ...
                Broker.Execute("CREATE TABLE MpTvDb.[dbo].TVMovieProgram ( idProgram int NOT NULL IDENTITY, TVMovieBewertung INT NOT NULL DEFAULT 0 , FanArt VARCHAR(255) , idSeries INT NOT NULL DEFAULT 0 , SeriesPosterImage VARCHAR(255) , idEpisode VARCHAR(15) , EpisodeImage VARCHAR(255) , local BIT NOT NULL DEFAULT 0 , idMovingPictures INT NOT NULL DEFAULT 0 , idVideo INT NOT NULL DEFAULT 0 , KurzKritik VARCHAR(255) , BildDateiname VARCHAR(255) , Cover VARCHAR(512) , Fun INT NOT NULL DEFAULT 0 , Action INT NOT NULL DEFAULT 0 , Feelings INT NOT NULL DEFAULT 0 , Erotic INT NOT NULL DEFAULT 0 , Tension INT NOT NULL DEFAULT 0 , Requirement INT NOT NULL DEFAULT 0 , Actors TEXT , Dolby BIT NOT NULL DEFAULT 0 , HDTV BIT NOT NULL DEFAULT 0 , Country VARCHAR(50) , Regie VARCHAR(50) , Describtion TEXT , ShortDescribtion TEXT , FileName VARCHAR(255) , PRIMARY KEY (idProgram))")
            Catch ex As Exception
                'Falls die Tabelle nicht existiert, abfangen & erstellen
                Broker.Execute("CREATE TABLE MpTvDb.[dbo].TVMovieProgram ( idProgram int NOT NULL IDENTITY, TVMovieBewertung INT NOT NULL DEFAULT 0 , FanArt VARCHAR(255) , idSeries INT NOT NULL DEFAULT 0 , SeriesPosterImage VARCHAR(255) , idEpisode VARCHAR(15) , EpisodeImage VARCHAR(255) , local BIT NOT NULL DEFAULT 0 , idMovingPictures INT NOT NULL DEFAULT 0 , idVideo INT NOT NULL DEFAULT 0 , KurzKritik VARCHAR(255) , BildDateiname VARCHAR(255) , Cover VARCHAR(512) , Fun INT NOT NULL DEFAULT 0 , Action INT NOT NULL DEFAULT 0 , Feelings INT NOT NULL DEFAULT 0 , Erotic INT NOT NULL DEFAULT 0 , Tension INT NOT NULL DEFAULT 0 , Requirement INT NOT NULL DEFAULT 0 , Actors TEXT , Dolby BIT NOT NULL DEFAULT 0 , HDTV BIT NOT NULL DEFAULT 0 , Country VARCHAR(50) , Regie VARCHAR(50) , Describtion TEXT , ShortDescribtion TEXT , FileName VARCHAR(255) , PRIMARY KEY (idProgram))")
            End Try
            ...
            Try
                'Table TvMovieSeriesMapping anlegen
                Broker.Execute("CREATE  TABLE mptvdb.[dbo].TvMovieSeriesMapping ( idSeries int NOT NULL, disabled bit NOT NULL DEFAULT '0', TvSeriesTitle varchar(255) DEFAULT NULL, EpgTitle varchar(255) DEFAULT NULL, minSeasonNum int NOT NULL DEFAULT '0', PRIMARY KEY (idSeries))")
                MyLog.[Debug]("TVMovie: [TvMovie++ Settings]: TvMovieSeriesMapping table created")
            Catch ex As Exception
                'existiert bereits
                MyLog.[Debug]("TVMovie: [TvMovie++ Settings]: TvMovieSeriesMapping table exist")
            ...
            Try
                'Table TVMovieEpisodeMapping anlegen
                Broker.Execute("CREATE TABLE mptvdb.[dbo].TvMovieEpisodeMapping ( idEpisode varchar(15) NOT NULL, idSeries int NOT NULL, EPGEpisodeName text, seriesNum int NOT NULL, episodeNum int NOT NULL, PRIMARY KEY (idEpisode) )")
                MyLog.[Debug]("TVMovie: [TvMovie++ Settings]: TvMovieEpisodeMapping table created")
            Catch ex As Exception
                'existiert bereits
                MyLog.[Debug]("TVMovie: [TvMovie++ Settings]: TvMovieEpisodeMapping table exist")
