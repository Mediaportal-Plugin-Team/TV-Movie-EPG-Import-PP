...
#Region "Retrieval"
        ...
        Public Overloads Shared Function RetrieveList(ByVal SQLStringAppendix As String, ByVal ChannelName As String) As List(Of TvMprogram)
            ...
            _SqlBuilder.Append(" Sendungen.Kurzkritik, Sendungen.Bewertungen, SendungenDetails.Beschreibung, Sendungen.KurzBeschreibung")
            _SqlBuilder.Append(" FROM Sendungen INNER JOIN SendungenDetails ON Sendungen.Pos = SendungenDetails.Pos {0};")
